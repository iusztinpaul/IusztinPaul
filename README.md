...
| Docker, FastAPI, Airflow, Kafka, Spark  | batch & online serving |
| DVC, Weights & Biases, MLFlow  | continuous training & monitoring |
| PostgreSQL, Elasticsearch, Redis  | REST API, gRPC & streaming design |
|   | cloud & microservices |
|   | distributed systems |
